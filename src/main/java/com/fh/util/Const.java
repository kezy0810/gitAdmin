...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((huoxing)|(login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(ueditor)|(file)|(video)).*";	//不对匹配该值的访问路径拦截（正则）
